<div class="py-16 md:py-24 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto text-center mb-16">
            <h2 class="text-3xl font-extrabold text-gray-900 sm:text-4xl mb-4">What Our Clients Say</h2>
            <p class="text-lg text-gray-600">Hear from bloggers and content creators who love our themes</p>
        </div>
